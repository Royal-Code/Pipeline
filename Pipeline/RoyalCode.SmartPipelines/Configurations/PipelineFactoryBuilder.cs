...
public class PipelineFactoryBuilder<TFor> : IPipelineFactoryBuilder<TFor>
{
    private static readonly ChainDelegateRegistry chainDelegateRegistry = new();

    private IServiceProvider? userServiceProvider = null;

    internal PipelineFactoryBuilder() 
    {
    ...
    /// </para>
    /// <para>
    ///     This collection will be ignored if the <see cref="PipelineFactoryBuilder{TFor}.ServiceProvider"/>
    ...
    /// </exception>
    public PipelineFactoryBuilder<TFor> ConfigurePipelines(Action<IPipelineBuilder> configurer)
    {
